...
dwr.engine._origScriptSessionId = "9D34D40C6D43EBE8CA32AAFFB994C9F0";
...
dwr.engine._sendData = function(batch) {
  ...
  if (batch.req) {
    ...
    if (batch.isPoll) {
      ...
      if (!IS_IE) batch.req.batch = batch;
    }
    ...
    if (batch.isPoll && window.ActiveXObject) {
      ...
      batch.div.innerHTML = "<iframe src='javascript:void(0)' frameborder='0' style='width:0;height:0;border:0;' id='" + idname + "' name='" + idname + "' onload='dwr.engine._iframeLoadingComplete (" + batch.map.batchId + ");'></iframe>";
