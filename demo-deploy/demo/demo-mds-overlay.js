...
(function() {
        ...
        evidence: [
          {
            ...
            pdfData: {
              filename: 'LAB_CBC_01_12_38001234.PDF',
              title: 'Laboratory Report - Complete Blood Count',
              pages: 1,
              content: [
                { text: 'LABORATORY REPORT', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                { text: 'Date Collected: 01/12/2026 06:30', highlight: false },
                { text: 'Ordering Physician: Dr. Demo Provider', highlight: false },
                { text: '', highlight: false },
                { text: 'COMPLETE BLOOD COUNT (CBC):', highlight: false },
                { text: '', highlight: false },
                { text: 'WBC:          7.8 x10³/µL          Ref: 4.5 - 11.0', highlight: false },
                { text: 'RBC:          3.2 x10⁶/µL    (L)  Ref: 4.0 - 5.5', highlight: false },
                { text: 'Hemoglobin:   9.8 g/dL        (L)  Ref: 12.0 - 16.0', highlight: 'keyword' },
                { text: 'Hematocrit:   30.2%           (L)  Ref: 36.0 - 46.0', highlight: 'keyword' },
                { text: 'MCV:          82 fL                Ref: 80 - 100', highlight: false },
                { text: 'MCH:          27.1 pg              Ref: 27 - 33', highlight: false },
                { text: 'MCHC:         32.4 g/dL            Ref: 32 - 36', highlight: false },
                { text: 'Platelets:    245 x10³/µL          Ref: 150 - 400', highlight: false },
                { text: '', highlight: false },
                { text: 'IRON STUDIES:', highlight: false },
                { text: 'Serum Iron:   35 mcg/dL       (L)  Ref: 60 - 170', highlight: 'keyword' },
                { text: 'Ferritin:     8 ng/mL         (L)  Ref: 12 - 150', highlight: 'keyword' },
                { text: 'TIBC:         450 mcg/dL      (H)  Ref: 250 - 370', highlight: false },
                { text: '', highlight: false },
                { text: 'INTERPRETATION: Iron deficiency anemia', highlight: 'keyword' },
                { text: '', highlight: false },
                { text: 'Lab Director: Robert Chen, MD, PhD', highlight: false },
                { text: 'CLIA# 22D0928956', highlight: false }
              ]
            }
          },
          {
            ...
            evidenceType: 'keyword',
            pdfData: {
              filename: 'ORDER_IRON_01_05_38001234.PDF',
              title: 'Physician Order - Iron Supplementation',
              pages: 1,
              content: [
                { text: 'PHYSICIAN ORDER', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                { text: 'Date: 01/05/2026', highlight: false },
                { text: 'Ordering Physician: Dr. Demo Provider', highlight: false },
                { text: '', highlight: false },
                { text: 'ORDER:', highlight: false },
                { text: 'Ferrous sulfate 325mg PO daily', highlight: 'keyword' },
                { text: 'Give with orange juice, separate from calcium by 2 hours', highlight: false },
                { text: '', highlight: false },
                { text: 'INDICATION: Iron deficiency anemia', highlight: 'keyword' },
                { text: '', highlight: false },
                { text: 'SUPPORTING LABS (01/02/2026):', highlight: false },
                { text: 'Hemoglobin: 9.8 g/dL (Low)', highlight: 'keyword' },
                { text: 'Hematocrit: 30.2% (Low)', highlight: false },
                { text: 'Serum Iron: 35 mcg/dL (Low)', highlight: 'keyword' },
                { text: 'Ferritin: 8 ng/mL (Low)', highlight: 'keyword' },
                { text: 'TIBC: 450 mcg/dL (High)', highlight: false },
                { text: '', highlight: false },
                { text: 'Electronically signed: Dr. Demo Provider, MD', highlight: false },
                { text: 'Date: 01/05/2026 at 11:30', highlight: false }
              ]
            }
          }
        ]
      ...
      },
      {
        ...
        evidence: [
          ...
          },
          {
            ...
            pdfData: {
              filename: 'NURSING_COGNITIVE_01_20_38001345.PDF',
              title: 'Nursing Assessment - Cognitive/Behavioral',
              pages: 1,
              content: [
                { text: 'NURSING ASSESSMENT - COGNITIVE/BEHAVIORAL', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                { text: 'Date: 01/20/2026 - 19:30', highlight: false },
                { text: 'Nurse: L. Davis, RN', highlight: false },
                { text: '', highlight: false },
                { text: 'COGNITIVE STATUS:', highlight: false },
                { text: 'Patient confused and disoriented to time this evening.', highlight: 'contextual' },
                { text: 'Asking for deceased spouse repeatedly.', highlight: 'contextual' },
                { text: 'Reorientation provided with limited effectiveness.', highlight: 'contextual' },
                { text: '', highlight: false },
                { text: 'BEHAVIORAL OBSERVATIONS:', highlight: false },
                { text: '- Wandering in hallway at 1845, redirected to room', highlight: 'contextual' },
                { text: '- Unable to recall dinner was served 30 minutes ago', highlight: 'contextual' },
                { text: '- Difficulty recognizing nursing staff from earlier shift', highlight: false },
                { text: '- Attempted to leave unit stating "I need to go home to cook"', highlight: 'contextual' },
                { text: '- Sundowning behavior noted - increased confusion after 1700', highlight: 'contextual' },
                { text: '', highlight: false },
                { text: 'SAFETY MEASURES:', highlight: false },
                { text: '- Bed alarm activated', highlight: false },
                { text: '- Door alarm in place', highlight: false },
                { text: '- 1:1 monitoring during peak sundowning hours', highlight: false },
                { text: '- Donepezil administered as ordered at 2100', highlight: false },
                { text: '', highlight: false },
                { text: 'Physician notified of increased confusion. No new orders.', highlight: false }
              ]
            }
          }
        ]
      },
      {
        ...
        evidence: [
          ...
          },
          {
            ...
            pdfData: {
              filename: 'NURSING_COMM_01_18_38001567.PDF',
              title: 'Nursing Communication Log',
              pages: 1,
              content: [
                { text: 'NURSING NOTE - COMMUNICATION LOG', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                { text: 'Date: 01/18/2026 - 10:15', highlight: false },
                { text: 'Nurse: A. Chen, RN', highlight: false },
                { text: '', highlight: false },
                { text: 'COMMUNICATION STATUS:', highlight: false },
                { text: 'Patient using gestures and pointing to communicate needs.', highlight: 'contextual' },
                { text: 'Unable to verbalize wants clearly.', highlight: 'contextual' },
                { text: '', highlight: false },
                { text: 'OBSERVATIONS:', highlight: false },
                { text: '- Patient attempted to request water but could not produce the word', highlight: 'contextual' },
                { text: '- Used pointing and hand gestures to indicate thirst', highlight: 'contextual' },
                { text: '- Became visibly frustrated when unable to express herself', highlight: false },
                { text: '- Responds appropriately to yes/no questions', highlight: false },
                { text: '- Follows simple one-step verbal commands', highlight: false },
                { text: '', highlight: false },
                { text: 'COMMUNICATION STRATEGIES USED:', highlight: false },
                { text: '- Picture communication board at bedside', highlight: false },
                { text: '- Yes/no questions for basic needs assessment', highlight: false },
                { text: '- Extra time allowed for patient response', highlight: false },
                { text: '', highlight: false },
                { text: 'SLP notified of ongoing communication difficulties.', highlight: false }
              ]
            }
          }
        ]
      },
      {
        ...
        evidence: [
          ...
          },
          {
            ...
            evidenceType: 'keyword',
            pdfData: {
              filename: 'LAB_KEPPRA_01_17_38001456.PDF',
              title: 'Laboratory Report - Anticonvulsant Level',
              pages: 1,
              content: [
                { text: 'LABORATORY REPORT', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                { text: 'Date Collected: 01/17/2026 07:00', highlight: false },
                { text: 'Ordering Physician: Dr. Demo Provider', highlight: false },
                { text: '', highlight: false },
                { text: 'THERAPEUTIC DRUG MONITORING:', highlight: false },
                { text: '', highlight: false },
                { text: 'Levetiracetam (Keppra) Level: 18.5 mcg/mL', highlight: 'keyword' },
                { text: 'Therapeutic Range: 12 - 46 mcg/mL', highlight: false },
                { text: 'Status: THERAPEUTIC', highlight: 'keyword' },
                { text: '', highlight: false },
                { text: 'CLINICAL NOTE:', highlight: false },
                { text: 'Level drawn following breakthrough seizure event on 01/17.', highlight: 'keyword' },
                { text: 'Level within therapeutic range. No dose adjustment', highlight: false },
                { text: 'recommended at this time.', highlight: false },
                { text: '', highlight: false },
                { text: 'Lab Director: Robert Chen, MD, PhD', highlight: false },
                { text: 'CLIA# 22D0928956', highlight: false }
              ]
      ...
      },
      {
        ...
        evidence: [
          ...
          },
          {
            ...
            pdfData: {
              filename: 'OT_COGNITIVE_01_16_38001678.PDF',
              title: 'Occupational Therapy Cognitive Assessment',
              pages: 1,
              content: [
                { text: 'OCCUPATIONAL THERAPY - COGNITIVE ASSESSMENT', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                { text: 'Date: 01/16/2026', highlight: false },
                { text: 'Therapist: Demo OTR, OTR/L', highlight: false },
                { text: '', highlight: false },
                { text: 'REASON FOR ASSESSMENT:', highlight: false },
                { text: 'Cognitive-functional evaluation following recent CVA with', highlight: false },
                { text: 'known history of traumatic brain injury (TBI) from fall in 2023.', highlight: 'contextual' },
                { text: '', highlight: false },
                { text: 'COGNITIVE SCREENING RESULTS:', highlight: false },
                { text: 'Attention: Impaired - unable to sustain attention >5 minutes', highlight: 'contextual' },
                { text: 'Memory: Severely impaired short-term recall (1/5 items at 5 min)', highlight: false },
                { text: 'Problem-solving: Impaired - requires maximum cues for simple tasks', highlight: 'contextual' },
                { text: 'Sequencing: Moderately impaired - difficulty with multi-step ADLs', highlight: false },
                { text: 'Safety awareness: Impaired - attempts unsafe transfers', highlight: false },
                { text: '', highlight: false },
                { text: 'CLINICAL IMPRESSION:', highlight: false },
                { text: 'Cognitive deficits are consistent with combined effects of', highlight: 'contextual' },
                { text: 'prior TBI (2023) and recent CVA. Executive dysfunction and', highlight: 'contextual' },
                { text: 'impulse control deficits predate the current stroke per medical history.', highlight: 'contextual' },
                { text: '', highlight: false },
                { text: 'PLAN: OT 5x/week focusing on cognitive retraining,', highlight: false },
                { text: 'safety awareness, and compensatory strategy training.', highlight: false }
              ]
            }
          }
        ]
      ...
      },
      {
        ...
        evidence: [
          ...
          },
          {
            ...
            pdfData: {
              filename: 'NURSING_BEHAVIOR_01_19_38001567.PDF',
              title: 'Nursing Behavioral Observation Note',
              pages: 1,
              content: [
                { text: 'NURSING NOTE - BEHAVIORAL OBSERVATION', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                { text: 'Date: 01/19/2026 - 16:45', highlight: false },
                { text: 'Nurse: M. Johnson, RN', highlight: false },
                { text: '', highlight: false },
                { text: 'OBSERVATION:', highlight: false },
                { text: 'Patient appears anxious during evening rounds.', highlight: 'contextual' },
                { text: 'Noted wringing hands and fidgeting with bed linens.', highlight: 'contextual' },
                { text: 'Asking repetitive questions about discharge date and', highlight: 'contextual' },
                { text: 'whether she will be able to return home.', highlight: false },
                { text: '', highlight: false },
                { text: 'ADDITIONAL OBSERVATIONS:', highlight: false },
                { text: '- Call light used 8 times during shift for non-urgent needs', highlight: 'contextual' },
                { text: '- Difficulty falling asleep, up at 2300 and 0100', highlight: 'contextual' },
                { text: '- Reports feeling "worried about everything"', highlight: 'contextual' },
                { text: '- Vital signs: HR 92 (elevated from baseline 72)', highlight: false },
                { text: '', highlight: false },
                { text: 'INTERVENTIONS:', highlight: false },
                { text: '- Reassurance and redirection provided', highlight: false },
                { text: '- Lorazepam 0.5mg given per PRN order at 1700', highlight: false },
                { text: '- Patient responded well, calmer within 30 minutes', highlight: false },
                { text: '- Will notify physician if pattern continues', highlight: false }
              ]
            }
          }
        ]
      },
      {
        ...
        evidence: [
          ...
          },
          {
            ...
            pdfData: {
              filename: 'NURSING_MOOD_01_20_38001456.PDF',
              title: 'Nursing Mood / Behavioral Assessment',
              pages: 1,
              content: [
                { text: 'NURSING ASSESSMENT - MOOD & BEHAVIOR', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                { text: 'Date: 01/20/2026 - 14:22', highlight: false },
                { text: 'Nurse: T. Williams, RN', highlight: false },
                { text: '', highlight: false },
                { text: 'MOOD OBSERVATION:', highlight: false },
                { text: 'Patient tearful during afternoon ADL care.', highlight: 'contextual' },
                { text: 'States "I just feel so hopeless about everything."', highlight: 'contextual' },
                { text: 'Patient refusing to participate in afternoon activities.', highlight: 'contextual' },
                { text: '', highlight: false },
                { text: 'BEHAVIORAL OBSERVATIONS:', highlight: false },
                { text: '- Flat affect noted throughout shift', highlight: 'contextual' },
                { text: '- Minimal eye contact during interactions', highlight: false },
                { text: '- Appetite poor - ate <25% of lunch tray', highlight: 'contextual' },
                { text: '- Remained in bed most of the day', highlight: false },
                { text: '- Declined to attend group therapy session', highlight: false },
                { text: '', highlight: false },
                { text: 'INTERVENTIONS:', highlight: false },
                { text: '- Therapeutic listening and emotional support provided', highlight: false },
                { text: '- Social work notified for follow-up', highlight: false },
                { text: '- Sertraline administered as ordered this AM', highlight: false },
                { text: '- Will continue to monitor mood and behavior', highlight: false }
              ]
            }
          }
        ]
        ...
        evidence: [
          {
            ...
            evidenceType: 'keyword',
            pdfData: {
              filename: 'ORDER_COMPRESSION_01_05_38001234.PDF',
              title: 'Physician Order - Compression Therapy',
              pages: 1,
              content: [
                { text: 'PHYSICIAN ORDER', highlight: false },
                { text: 'Patient: Doe, Jane', highlight: false },
                ...
                { text: '', highlight: false },
                { text: 'ORDER:', highlight: false },
                { text: 'Compression stockings bilateral lower extremities', highlight: 'keyword' },
                { text: 'TED hose thigh-high, apply every morning, remove at bedtime', highlight: 'keyword' },
                { text: '', highlight: false },
                { text: 'DIAGNOSIS: Peripheral vascular disease (PVD)', highlight: 'keyword' },
                { text: '', highlight: false },
                { text: 'CLINICAL JUSTIFICATION:', highlight: false },
                { text: 'Patient has documented peripheral vascular disease with', highlight: 'keyword' },
                { text: 'bilateral lower extremity edema and venous insufficiency.', highlight: false },
                { text: 'ABI right: 0.72, ABI left: 0.68 - consistent with mild PVD.', highlight: 'keyword' },
                { text: '', highlight: false },
                { text: 'ADDITIONAL ORDERS:', highlight: false },
                { text: '- Elevate lower extremities when seated', highlight: false },
                { text: '- Monitor skin integrity daily', highlight: false },
                { text: '- Report any new skin breakdown or color changes', highlight: false },
                { text: '', highlight: false },
                { text: 'Electronically signed: Dr. Demo Provider, MD', highlight: false },
                { text: 'Date: 01/05/2026 at 09:15', highlight: false }
              ]
            }
          }
        ]
  ...
  function showPopover(anchorEl, itemData) {
    ...
    popover.querySelectorAll('.super-evidence-card').forEach(card => {
      card.addEventListener('click', () => {
        ...
        } else if (evidence.tarData) {
          showTARViewer(evidence, itemData);
  ...
  function showEvidenceModal(itemData) {
    ...
    modal.querySelectorAll('.super-evidence-card').forEach((card, index) => {
      ...
      if (evidence && (evidence.pdfData || evidence.marData || evidence.tarData)) {
