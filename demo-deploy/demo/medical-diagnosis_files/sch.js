...
function displayPhoto(clientId){
	openPopupWin("/tools/photo/displayphoto.jsp?ESOLclientid="+clientId+"&ESOLtabtype=C", 'residentPhoto', 575, 480, 'scrollbars=1');
}

function displayCareProfile(clientId, clientNameNumber){
	careProfileFormPopup = openPopupWin("/clinical/client/careprofile/showCareProfile.xhtml?ESOLclientid="+clientId+"&clientNameNumber="+clientNameNumber, 'careProfileFormPopup', 1050, 700, 'toolbar=no,status=no,directories=no,menubar=no,resizable=yes,location=1,scrollbars=no');
}
